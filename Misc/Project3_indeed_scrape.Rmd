...
```
```{r}
#base_linkedin <- 'https://www.linkedin.com/search/results/people/v2/?origin=FACETED_SEARCH&page=1&title=data%20scientist'
```
...
kws <- c('Python',
         ...
         'remote(ly)?',
         regex('Bachelors| BA ', ignore_case = T),
         regex('Masters| MA', ignore_case = T),
         'PhD',
