...
author: "Sachid Deshmukh, Mohammad Younus, Robert Lauto, Santosh Manjrekar, Olga Shiligin, Hantz Angrand"
...
run_indeed_job_search <- function(){
  ...
  skill_terms.df <- read.csv("https://media.githubusercontent.com/media/mlforsachid/Data607-Project3/master/Data/indeed_skills.csv", header = TRUE)
  skill_terms <- trimws(skill_terms.df$SKILL)
  head(skill_terms)
  
  cities.df <- read.csv("https://media.githubusercontent.com/media/mlforsachid/Data607-Project3/master/Data/indeed_city_state.csv", header = TRUE)
